...
for i = 1 :Validation_amount 
    ...
    elseif i > Validation_amount*0.9 && i <= Validation_amount*0.95
        ...
        %save info to meta
        meta_info_Validation{i,1} = Fe2_normalize(index).group;
        meta_info_Validation{i,2} = "None";
        ...
        %save info to meta
        meta_info_Validation{i,1} = Fe3_normalize(index).group;
        meta_info_Validation{i,2} = "None";
